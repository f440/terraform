resource "aws_elasticache_replication_group" "plus-omen-api-production" {
  replication_group_id          = "omen-api-production"
  replication_group_description = "Redis instance for omen-api-production"
  ...
  parameter_group_name = "${aws_elasticache_parameter_group.plus-omen-api-redis-32.name}"
...
resource "aws_elasticache_parameter_group" "plus-omen-api-redis-32" {
  name        = "omen-api-redis-32"
  family      = "redis3.2"
